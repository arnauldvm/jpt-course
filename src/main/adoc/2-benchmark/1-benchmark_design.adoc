...
[WARNING]
====
The timestamp given in the logs may be either the time of request
or the time of response, depending on the system!

[horizontal]
jmeter:: *response time* by default, configurable through +sampleresult.timestamp.start+
httpd:: *request time* by default (+%t+), configurable by using +%begin:t+ or +%end:t+
Tomcat:: *request time*
WebLogic:: *response time*
====
